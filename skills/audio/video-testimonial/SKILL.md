...
1. "What was managing projects like before [Tool]?"
   (What was frustrating? What took too long?)

2. "What's different now that you're using [Tool]?"
   (Specific changes, time saved, results)

3. "What would you tell someone considering [Tool]?"
...
**Script for guiding**:
"Okay, we're recording. Just look at me, not the camera.
First, tell me what your [kitchen/bathroom/etc.] was like before we started...
[wait for answer]
Great. Now, what's it like now that it's done?
[wait]
Perfect. Last one: what would you tell a neighbor considering a renovation?"
...
**Step 3**: Turn phone SIDEWAYS (horizontal)
**Step 4**: Stand in your new [room]
**Step 5**: Hit the red RECORD button
...
**Step 6**: Hit STOP
**Step 7**: Text the video to [number] OR email to [address]
...
- [remote-interview](../remote-interview/) - For longer-form customer interviews
- [voiceover-direction](../voiceover-direction/) - Directing customer performance
- [video-production](../../video/video-production/) - When professional production is needed
- [transcription-to-content](../transcription-to-content/) - Repurposing testimonial content

...
1. **Makes audio searchable** - Transcripts that Google can index
2. **Structures content for SEO** - Show notes optimized for ranking
3. **Targets valuable keywords** - Research-driven episode planning
4. **Builds topical authority** - Content clusters around themes
5. **Drives long-term traffic** - Compounding organic growth
...
| Resources | 50-100 words |
| Guest bio | 50-100 words |
| Transcript | 3,000-10,000 words |
| **Total** | **4,000-11,000 words** |
```

---

### Step 5: Technical SEO for Podcasts

Ensure proper indexing and structure.
...
Track SEO performance of podcast content.
...
### Example 1: Episode SEO Optimization

**Context**: Optimizing an existing episode for search.

**Input**:
> Optimize this episode for SEO: "Building Your Personal Brand" with Lisa Chen, marketing consultant. Episode is about personal branding for B2B professionals.

**Output**:

## SEO Optimization: Personal Branding Episode

### Keyword Research

**Primary keyword**: "personal branding for B2B" (720 monthly searches, medium difficulty)

**Secondary keywords**:
- "B2B personal branding strategy" (210/mo)
- "LinkedIn personal branding" (1,900/mo)
- "personal brand for consultants" (320/mo)
- "how to build personal brand B2B" (90/mo)
...
- Link TO this episode from blog posts about LinkedIn, personal branding, B2B marketing
- Link FROM this episode to related episodes about LinkedIn strategy, content marketing

---

### Example 2: Podcast SEO Audit

**Context**: Auditing and improving podcast SEO.

**Input**:
> Audit my podcast's SEO. We have 50 episodes, no transcripts, basic show notes (just bullet points), and get almost no organic search traffic.

**Output**:

## Podcast SEO Audit Results

### Current State: Grade D

**Issues Identified**:
1. ❌ No transcripts = No searchable content
2. ❌ Thin show notes = Poor ranking signals
3. ❌ No keyword strategy = Random topic selection
4. ❌ No schema markup = Missing rich results
5. ❌ Weak internal linking = No topical authority

### Impact Assessment

**Estimated lost opportunity**:
- 50 episodes × avg 5,000 words = 250,000 words of indexable content NOT indexed
- If just 10 episodes ranked for 1 keyword each with 500 monthly searches = 5,000 potential monthly visitors missing

### Remediation Plan

**Phase 1: Quick Wins (Week 1-2)**
- Add schema markup to all episode pages
- Expand show notes to 500+ words per episode (start with 10 most popular)
- Create podcast landing page optimized for "[Your Topic] podcast"

**Phase 2: Transcript Implementation (Week 3-6)**
- Transcribe top 20 episodes (by downloads or relevance)
- Edit for readability and SEO
- Publish with proper formatting
- Continue with remaining episodes

**Phase 3: Keyword Strategy (Week 7-8)**
- Research keywords for your niche
- Map existing episodes to keywords
- Plan future episodes around keyword opportunities
- Update existing show notes with keyword focus

**Phase 4: Content Structure (Week 9-12)**
- Create topic cluster pages
- Build internal linking strategy
- Add related episode sections
- Implement FAQ sections where relevant

### Priority Episodes for Transcription

Select based on:
1. Evergreen topics (not time-sensitive)
2. High-volume keywords
3. Strong download numbers (proven interest)
4. Guest authority (backlink potential)

### Expected Results

**Timeline**: 6-12 months for meaningful results

**Metrics to expect**:
- Month 3: First keywords indexing
- Month 6: 500-1,000 monthly organic visitors
- Month 12: 2,000-5,000 monthly organic visitors

*Based on industry benchmarks for consistent podcast SEO implementation*

## Checklists & Templates

### Episode SEO Checklist
...
- This American Life. "The Value of Transcripts" - 4.36% traffic increase case study
- Moz. "Podcast SEO Guide" - Technical implementation
- Rev. "Podcast SEO with Transcripts" - Industry research
- Google. "Podcast Indexing Guidelines" - Official documentation

## Related Skills

- [transcription-to-content](../transcription-to-content/) - Repurposing transcripts
- [podcast-production](../podcast-production/) - Creating the content
- [podcast-interview](../podcast-interview/) - Getting great source material

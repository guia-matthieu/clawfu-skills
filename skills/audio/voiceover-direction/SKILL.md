...
1. **Creates effective VO briefs** - Documents that give talent everything they need
2. **Casts the right voice** - Matching voice characteristics to brand and audience
3. **Writes speakable scripts** - Copy that sounds natural when spoken
4. **Directs sessions effectively** - Getting the performance you need
5. **Gives actionable feedback** - Direction that improves takes, not confuses
...
- [voice-design](../voice-design/) - AI voice selection and creation
- [audiobook-production](../audiobook-production/) - ACX-compliant production
- [podcast-production](../podcast-production/) - Hosting/narration techniques

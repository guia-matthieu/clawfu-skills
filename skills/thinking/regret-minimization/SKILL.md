...
- [second-order-thinking](../second-order-thinking/) - Consider consequences of choices
- [reversible-decisions](../reversible-decisions/) - Type 1 vs. Type 2 decisions
- [first-principles](../../strategy/first-principles/) - Challenge assumptions about risk
- [inversion](../../strategy/inversion/) - Think backward from failure
- [pre-mortem](../../strategy/pre-mortem/) - Anticipate what could go wrong

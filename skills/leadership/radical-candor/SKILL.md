...
1. **Defines the four quadrants** - Radical Candor, Ruinous Empathy, Obnoxious Aggression, Manipulative Insincerity
2. **Teaches caring personally** - Building genuine relationships
3. **Develops challenging directly** - Having necessary hard conversations
4. **Provides feedback frameworks** - How to give effective criticism and praise
5. **Builds a feedback culture** - Teams that can handle candor
6. **Avoids management traps** - Especially "ruinous empathy"
...
1. In meetings, let people finish their thoughts before responding
2. When you feel strongly, say 'I disagree because...' rather
   than raising your voice
3. Actively ask quieter team members for input
...
1. **Share your own development area**
   In team meeting: "Something I'm working on is [X]. I'd
   appreciate feedback when you see me doing it."

2. **Publicly receive feedback well**
   Ask in meetings: "What could I have done better?"
   When you get feedback: Thank them. Don't defend.

3. **Admit mistakes publicly**
   "I made a bad call on [X]. Here's what I learned."
...
- [one-on-ones](../one-on-ones/) - 1:1 deep dive
- [never-split-difference](../../sales/never-split-difference/) - Difficult conversations
- [objection-mapping](../../validation/objection-mapping/) - Handling pushback
